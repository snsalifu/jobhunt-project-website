                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea name="" class="form-control h_100" cols="30" rows="10">{{ $page_home_data->text }}</textarea>
                                                </div>
                                                <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="job_category_status" class="form-control">
                                                        <option value="Show" @if($page_home_data->job_category_subheading == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->job_category_subheading == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="why_choose_status" class="form-control">
                                                        <option value="Show" @if($page_home_data->why_choose_subheading == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->why_choose_subheading == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="featured_jobs_status" class="form-control">
                                                        <option value="Show" @if($page_home_data->featured_jobs_subheading == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->featured_jobs_subheading == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab" tabindex="0">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    <label class="form-label">Sub Heading </label>
                                                    <input type="text" class="form-control" name="why_choose_subheading" value="{{ $page_home_data->testimonial_subheading }}">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label">Existing Background *</label>
                                                    <div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="testimonial_status" class="form-control">
                                                        <option value="Show" @if($page_home_data->testimonial_subheading == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->testimonial_subheading == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select name="blog_status" class="form-control">
                                                        <option value="Show" @if($page_home_data->blog_subheading == 'Show') selected @endif>Show</option>
                                                        <option value="Hide" @if($page_home_data->blog_subheading == 'Hide') selected @endif>Hide</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
