            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 left-side">
                        <ul>
                            <li class="phone-text">+233-244-469-333</li>
                            <li class="email-text">contact@snsalifu.com</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <div class="list-item">
                                ...
                                <div class="right">contact@snsalifu.com</div>
                            </div>
                            <div class="list-item">
                                <div class="left">
                                    <i class="fas fa-envelope"></i>
                                </div>
                                <div class="right">+233-244-469-333</div>
                            </div>
                            <ul class="social">
                                <li>
                                    <a href=""
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright">
                            Copyright 2023, snsalifu. All Rights Reserved.
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="right">
